...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	$(CONTROLLER_GEN) $(CRD_OPTIONS) rbac:roleName=manager-role webhook paths="{./apis/fluentbit/...,./controllers/...}" output:crd:artifacts:config=charts/fluent-operator/charts/fluent-bit-crds/crds
	$(CONTROLLER_GEN) $(CRD_OPTIONS) rbac:roleName=manager-role webhook paths="{./apis/fluentd/...,./controllers/...}" output:crd:artifacts:config=charts/fluent-operator/charts/fluentd-crds/crds
